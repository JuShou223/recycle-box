    ...
    return (
      <View className="min-h-screen bg-gray-50 p-5">
        <View className="text-center py-10 px-5 bg-white rounded-2xl shadow-sm">
          <Text className="text-lg font-bold text-gray-800 block mb-3">请扫描回收箱二维码</Text>
          <Text className="text-sm text-gray-600 block mb-6 leading-relaxed">将摄像头对准回收箱上的二维码进行扫描</Text>
          <Button 
            type='primary' 
